...
const translations = {
  zh: {
    ...
    calRecordingPrompt: '逐个移动每个关节到其完整运动范围，完成后点击停止。',
    calStopRecording: '停止录制',
    calDone: '校准完成',
    cancel: '取消',
  ...
  en: {
    ...
    calRecordingPrompt: 'Move each joint through its full range of motion. Click stop when done.',
    calStopRecording: 'Stop Recording',
